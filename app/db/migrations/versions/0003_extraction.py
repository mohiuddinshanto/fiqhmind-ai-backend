...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["job_id"], ["ingestion_jobs.id"], name="fk_page_extractions_job_id_ingestion_jobs"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["page_extraction_id"], ["page_extractions.id"], name="fk_page_blocks_page_extraction_id_page_extractions"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["block_id"], ["page_blocks.id"], name="fk_page_spans_block_id_page_blocks"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["page_extraction_id"], ["page_extractions.id"], name="fk_page_images_page_extraction_id_page_extractions"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["page_extraction_id"], ["page_extractions.id"], name="fk_page_drawings_page_extraction_id_page_extractions"),
        sa.PrimaryKeyConstraint("id", name="pk_page_drawings"),
        sa.UniqueConstraint("page_extraction_id", "drawing_index", name="uq_page_drawings_page_index"),
    )
